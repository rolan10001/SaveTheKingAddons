...
public class Soldier extends RolesImpl implements Power {
	
	private final Category category = Category.SERVANT;
	private boolean power = true;
	
	public Soldier(STKGameManager game, @NotNull UUID uuid) {
		super(game, uuid);
	}

	@Override
	public String getDescription() {
		return STKPlugin.getInstance().getSTKConfig().getString("stk.role.soldier.description");
	}

	@Override
	public String getDisplay() {
		return STKPlugin.getInstance().getSTKConfig().getString("stk.role.soldier.display");
	}
